    ...
    class MainClass
    {
        static void Main()
        {
            ...
            IRoom greenHotel = new Hotel(4, "GreenDeer", "вул. Т. Шевченка",
                "Myyyyyyyyyyyyyyyyy Myyyyyyyyyyyyyyyyy Myyyyyyyyyyyyyyyyy Myyyyyyyyyyyyyyyyy Myyyyyyyyyyyyyyyyy")
            {
                City = City.Kyiv,
                Rating = 12,
                NumberOfStars = 5
            };
            greenHotel.CreateRoom(2, 2, "aZUL", 1, (Hotel)greenHotel /*Downcasting*/, true, "Big", 5, true); 
